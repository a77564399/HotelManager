...
<body>
    ...
    <table class="tablelist">
    	<thead >
    	<tr align="center">
        <th>房间号<i class="sort"><img src="<%=cxtPath %>/static/img/px.gif" /></i></th>
        <th>房间状态</th>
        <th>房间价格</th>
        <th>操作</th>
        </tr>
        ...
        <td width="30%"><a href="<%=request.getContextPath() %>/backStage/sys/UpdateRoom.jsp?roomNo=${room.num}" class="tablelink">修改信息</a>&nbsp;&nbsp; <a href="delRoom.do?roomNum=${room.num}" class="tablelink"> 删除房间</a></td>
    ...
    <div class="tip">
      ...
      <div class="tipinfo">
        ...
        <tr>
        	<td>房间号码&nbsp;&nbsp;</td>
        	<td><input type="text" class="form-control" placeholder="Text input" style="width:150%" name="roomNum"></td>
        </tr>
        <tr><td>&nbsp;&nbsp;</td></tr>
        
        <tr>
        	<td>价格&nbsp;&nbsp;</td>
        	<td><input type="text" class="form-control" placeholder="Text input" style="width:150%" name="price"></td>
        </tr>
        </table>
        </div>
        </div>
