    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav navbar-right">
		...
		<ul class="nav nav-pills nav-justified" style="width:20%;position:relative;left:40px;">
			<li id="" role="presentation" ><a href="generDoIn.jsp?room_num=${param.room_num }">普通用户入住</a></li>
			<li role="presentation" class="active"><a href="#">会员用户入住</a></li>
		</ul>
		<br>
		<table>
				...
				<td><input type="text" class="form-control" placeholder="Text input" style="width:150%" name="vipCard"></td>
			</tr>
			<tr>
			<td>&nbsp;</td>
			</tr>
			...
			<tr>
				<td>客户类型&nbsp;&nbsp;</td>
				<td><input type="text" class="form-control" placeholder="Text input"  value="会员" id="room_num" name="type" readonly style="width:50%"></td>
			</tr>
			<td>&nbsp;</td>
			<tr>
				<td><h4>住宿金额</h4>&nbsp;&nbsp;</td>
